 ...
 */
final class Version20260718191310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sector (id BINARY(16) NOT NULL, name VARCHAR(100) NOT NULL, code VARCHAR(20) NOT NULL, is_other TINYINT NOT NULL, UNIQUE INDEX UNIQ_4BA3D9E85E237E06 (name), UNIQUE INDEX UNIQ_4BA3D9E877153098 (code), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
